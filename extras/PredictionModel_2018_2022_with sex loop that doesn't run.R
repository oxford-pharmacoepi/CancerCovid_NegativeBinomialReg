...
figure_modelling_age_gender <-ggarrange(age_gender_Breast, age_gender_Colorectal, age_gender_Lung, age_gender_Prostate,
                              align="hv", ncol=2, nrow=2,
                              labels = c("A) Breast Cancer", "B) Colorectal Cancer", "C) Lung Cancer", "D) Prostate Cancer"),font.label = list(size = 12),
                              hjust = c(-0.25,-0.25),
                              common.legend=TRUE, legend="right" )

figure_modelling_age_gender


ggsave(here("4_Results", db.name, "Plots", "Figure_3_modelling_age_gender.jpg"), figure_modelling_age_gender, dpi=300, scale = 1.25,  width = 16, height = 10)
